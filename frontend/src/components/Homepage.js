    ...
    return (
      <>
        <div className="isolate bg-white">
          <div className="absolute transform-gpu overflow-hidden blur-3xl">
            <svg
                  ...
                  <div className="hidden sm:mb-8 sm:flex sm:justify-center">
                    <div className="shadow-xl relative overflow-hidden rounded-full py-1.5 px-4 text-sm leading-6 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                      <span className="text-gray-600">
                        Companies that respond to reviews are seen more
                        favorably.{" "}
                        <a
                  ...
                  <div>
                    ...
                    <div className="mt-8 flex w-full gap-x-4 sm:justify-center">
                      <button
                        ...
                        className="inline-flex shadow-xl rounded-lg text-white bg-black px-4 py-1.5 text-base font-semibold leading-7 shadow-sm ring-1 hover:bg-slate-700 hover:ring-red-700"
                      >
                        Continue to console
        ...
        <div className="bg-white py-16 pb-10 sm:py-0 lg:py-0">
          <div className="mx-auto max-w-7xl px-6 pb-20 lg:px-8">
            <div className="sm:text-center">
              ...
              <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-gray-600">
                Businesses that respond to reviews are 1.7 times more
                trustworthy.
              </p>
            </div>
